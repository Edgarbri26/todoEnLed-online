class headerEmpleado extends HTMLElement{
    constructor(){
        super();
        this.render();
    }
    ...
    render(){
        this.innerHTML = /*HTML*/
        `
        <header class=" bg-azul-principal shadow top-0 px-24 text-center h-16 col-span-2">
...
customElements.define('header-empleado',headerEmpleado);